...
define("WATER_MASK_IMG", ROOT."code/default_img/water_mask.gif");
	
class water_mark{
	static function makeWaterMark($des_image, $source_file = '', $transparency = 30, $margin = 5, $pos = 'bottomright'){
		if($source_file == ''){
			$source_file = WATER_MASK_IMG; 
		}else{
			$source_file = ROOT."siteInfo/$source_file";
		}
